...
ADC.o: source/ADC.c include/ADC.h
	$(ARMCC) -c -fPIC -mcpu=arm9 -Wall -Wno-trigraphs -I $(DIR_ACTUAL)/include -I $(INCLUDESNMP) source/ADC.c -o obj/ADC.o

monitorNodo.o: source/monitorNodo.c
	$(ARMCC) -c -fPIC -mcpu=arm9 -Wall -Wno-trigraphs -I $(DIR_ACTUAL)/include -I $(INCLUDESNMP) source/monitorNodo.c -o obj/monitorNodo.o

utilidades.o: source/utilidades.c include/utilidades.h
	$(ARMCC) -g -fPIC -c -mcpu=arm9 -Wall -Wno-trigraphs -I $(DIR_ACTUAL)/include -I $(INCLUDESNMP) source/utilidades.c -o obj/utilidades.o

IPC.o: source/IPC.c include/IPC.h
	$(ARMCC) -g -fPIC -c -mcpu=arm9 -Wall -Wno-trigraphs -I $(DIR_ACTUAL)/include -I $(INCLUDESNMP) source/IPC.c -o obj/IPC.o

monitordef.o: source/monitordef.c include/monitordef.h
	$(ARMCC) -g -fPIC -c -mcpu=arm9 -Wall -Wno-trigraphs -I $(DIR_ACTUAL)/include -I $(INCLUDESNMP) source/monitordef.c -o obj/monitordef.o

snmpdef.o: source/snmpdef.c include/snmpdef.h
	$(ARMCC) -g -fPIC -c -mcpu=arm9 -Wall -Wno-trigraphs -I $(DIR_ACTUAL)/include -I $(INCLUDESNMP) source/snmpdef.c -o obj/snmpdef.o

modBD.o: source/modBD.c include/modBD.h
	$(ARMCC) -g -fPIC -c -mcpu=arm9 -Wall -Wno-trigraphs -I $(DIR_ACTUAL)/include -I $(INCLUDESNMP) source/modBD.c -o obj/modBD.o

email.o: source/email.c include/email.h
	$(ARMCC) -g -fPIC -c -mcpu=arm9 -Wall -Wno-trigraphs -I $(DIR_ACTUAL)/include -I $(INCLUDESNMP) source/email.c -o obj/email.o

mediciones.o: source/mediciones.c include/mediciones.h
	$(ARMCC) -g -fPIC -c -mcpu=arm9 -Wall -Wno-trigraphs -I $(DIR_ACTUAL)/include -I $(INCLUDESNMP) source/mediciones.c -o obj/mediciones.o

DIO.o: source/DIO.c include/DIO.h
	$(ARMCC) -g -fPIC -c -mcpu=arm9 -Wall -Wno-trigraphs -I $(DIR_ACTUAL)/include -I $(INCLUDESNMP) source/DIO.c -o obj/DIO.o
